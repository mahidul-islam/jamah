...
urlpatterns = [
    ...
    path('<int:event_id>/ammas_finance', views.ammas_finance, name = 'ammas_finance'),
    ...
    path('<int:event_id>/add_observers', views.add_observers, name = 'add_observers'),
    ...
    path('<int:event_id>/transaction/<int:transaction_id>/deny', views.deny_transaction, name = 'deny_transaction'),
    ...
    path('<int:event_id>/accauntant_transaction', views.accauntant_transaction, name = 'accauntant_transaction'),
    path('<int:event_id>/change_head_accountant', views.change_head_accountant, name = 'change_head_accountant'),
    path('<int:event_id>/create_cost', views.create_cost, name = 'create_cost'),
